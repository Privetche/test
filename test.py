...
class PandasModel(QtCore.QAbstractTableModel):
    ...
    def filter_data(self):
        self.data = self._data.copy(deep=True)
        value1 = unicode(str(self.filters[u'Фамилия'].text()))
        value2 = unicode(str(self.filters[u'Имя'].text()))
        value3 = unicode(str(self.filters[u'Отчество'].text()))
        value4 = unicode(str(self.filters[u'Дата рождения'].text()))
        value5 = unicode(str(self.filters[u'Серия полиса'].text()))
        value6 = unicode(str(self.filters[u'Номер полиса'].text()))
        value7 = unicode(str(self.filters[u'Серия документа'].text()))
        value8 = unicode(str(self.filters[u'Номер документа'].text()))
...
def main():
    ...
    model.filters = {u'Фамилия': box1, u'Имя': box2, u'Отчество': box3, u'Дата рождения': box4, u'Серия полиса': box5,
              u'Номер полиса': box6, u'Серия документа': box7, u'Номер документа': box8}
